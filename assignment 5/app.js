...
function checkGuess(guess){
    ...
    if (guess === randomNumber){
        m=`Congratulations! You got it right !`;
        Correctans.innerHTML = `<h2 style="background-color:green;">${m}</h1>`;
        Wrongans.innerHTML = `<h1 style="background-color:white;"></h1>`;
        endGame();


    } else if (guess < randomNumber) {
        m=`Too low! Try again!`;
        Wrongans.innerHTML = `<h1 style="background-color:red;">${m}</h1>`;
        //endGame();
        //displayMessage();
    } else if (guess > randomNumber) {

        m=`Too High! Try again!`;
        Wrongans.innerHTML = `<h1 style="background-color:red;">${m}</h1>`;
        //endGame();
        //displayMessage();
    }
